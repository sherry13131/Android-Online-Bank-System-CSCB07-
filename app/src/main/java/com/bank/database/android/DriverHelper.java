...
public class DriverHelper extends DatabaseDriverA {
  ...
  /**
   * Returns an enummap of the roles in the database
   *
   * @return an enummap of the roles in the database
   */
  ...
  /**
   * Returns a list of all the user ids in the database.
   *
   * @return a list of all the user ids in the database
   */
  ...
  /**
   * Returns a list of the account ids of a user.
   *
   * @param userId the user for the accounts
   * @return a list of the account ids for the user
   */
  ...
  /**
   * Returns a list of all the account types in the database.
   *
   * @return a list of all the account types in the database.
   */
  ...
  /**
   * Returns an enummap of all the account types.
   *
   * @return an enummap of all the account types.
   */
