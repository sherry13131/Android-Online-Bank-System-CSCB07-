...
public class AtmMainMessageActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_atm_main_message);
    ...
    messagesView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intentResult = new Intent(AtmMainMessageActivity.this,
            AtmViewMessageActivity.class);
