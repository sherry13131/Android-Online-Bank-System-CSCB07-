...
public class AdminMenuActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    newTeller.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        // add admin id to intent
        Intent intentNewTeller = new Intent(AdminMenuActivity.this, NewTellerActivity.class);
    ...
    tellerList.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        startActivity(new Intent(AdminMenuActivity.this, TellerListActivity.class));
      }
    });
    ...
    customerList.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        startActivity(new Intent(AdminMenuActivity.this, CustomerListActivity.class));
      }
    });
